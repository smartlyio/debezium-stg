...
{%- call dbt_unit_testing.test(
  'to_stg_layer_scd4_postgres_compound_key',
...
{%- call dbt_unit_testing.test(
  ...
  {%- call dbt_unit_testing.expect(options={'input_format': 'csv'}) -%}
    ...
    2,'59cdcc9f','Stephen'  ,'King','1970-02-05T00:00:00.000Z','2023-01-25T14:56:18.883Z','r','71768bbf0e134dbb3cf5c51703cda3af',1,'2023-01-31T14:29:09.051Z'
    2,'59cdcc9f','Stanislav','Lem' ,'1970-03-17T00:00:00.000Z','2023-01-25T14:56:29.363Z','u','71768bbf0e134dbb3cf5c51703cda3af',2,'2023-01-31T14:29:09.051Z'
  {%- endcall -%}
{%- endcall -%}
...
{%- call dbt_unit_testing.test(
  ...
  {%- call dbt_unit_testing.expect(options={'input_format': 'csv'}) -%}
    {{ scd4_compound_key_header_csv() }}
      3,'15aa2814','Claude','Monet','1970-03-17T00:00:00.000Z','2023-01-25T14:56:18.883Z','r','07b56a10ca9076ca177242710c7877f3',1,'2023-01-31T14:29:09.051Z'
      3,'15aa2814',''      ,''     ,'1970-01-01T00:00:00.000Z','2023-01-25T14:56:29.463Z','d','07b56a10ca9076ca177242710c7877f3',2,'2023-01-31T14:29:09.051Z'
  {%- endcall -%}
{%- endcall -%}
...
{%- call dbt_unit_testing.test(
  ...
  {%- call dbt_unit_testing.expect() -%}
    SELECT
      ...
      '' AS name,
      '' AS surname,
      '1970-01-01T00:00:00.000Z' AS birthday,
      '2023-01-25T14:56:29.063Z'::TIMESTAMP_NTZ AS __valid_from__,
      'd' AS __op__,
      'd765428a228d82071e3c2390a76652f1' AS __inner_key__,
      1 AS __rolling_row_id__,
      '2023-01-31T14:29:09.051Z'::TIMESTAMP_NTZ AS __loaded_at__
  {%- endcall -%}
{%- endcall -%}
...
{%- call dbt_unit_testing.test(
  ...
  {%- call dbt_unit_testing.expect(options={'input_format': 'csv'}) -%}
    {{ scd4_compound_key_header_csv() }}
    13,'cbd868a3',''    ,''        ,'1970-01-01T00:00:00.000Z','2023-01-25T14:56:29.163Z','d','609afb2ab9ecf6e804f8540663bc46af',1,'2023-01-31T14:29:09.051Z'
    13,'cbd868a3','Rene','Magritte','1970-05-04T00:00:00.000Z','2023-01-25T14:56:29.263Z','c','609afb2ab9ecf6e804f8540663bc46af',3,'2023-01-31T14:29:09.051Z'
  {%- endcall -%}
{%- endcall -%}
...
{%- call dbt_unit_testing.test(
  ...
  {%- call dbt_unit_testing.mock_ref(
    ...
    {{ scd4_compound_key_processed_entities_model_csv() }}
  {%- endcall -%}
  {%- call dbt_unit_testing.expect() %}
    SELECT
      14 AS maj_id,
...
{%- call dbt_unit_testing.test(
  ...
  {%- call dbt_unit_testing.expect() %}
    SELECT
      ...
      'Gustav' AS name,
      'Klimt' AS surname,
      '2001-08-20T00:00:00.000Z'::TIMESTAMP_NTZ AS birthday,
      '2023-02-03T12:29:08.096Z'::TIMESTAMP_NTZ AS __valid_from__,
      'u' AS __op__,
      '2fb83d5eb811ce22d6f020e4f4f146cb' AS __inner_key__,
      13 AS __rolling_row_id__,
      '2023-02-03T14:29:09.051Z'::TIMESTAMP_NTZ AS __loaded_at__
  {% endcall -%}
{%- endcall -%}
...
{%- call dbt_unit_testing.test(
  ...
  {%- call dbt_unit_testing.expect() %}
    SELECT
      ...
      '' AS name,
      '' AS surname,
      '1970-01-01T00:00:00.000Z'::TIMESTAMP_NTZ AS birthday,
      '2023-02-03T12:29:08.396Z'::TIMESTAMP_NTZ AS __valid_from__,
      'd' AS __op__,
